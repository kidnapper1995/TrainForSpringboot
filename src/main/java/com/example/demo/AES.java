...
public class AES {
    ...
    public static void main(String[] args) throws Exception {
        ...
        params1.put("userid", "15225585511");
        params1.put("phone", "1896562142011");
        String content1 = JSON.toJSONString(params);
        String encrypt1=aesEncrypt(content1, KEY);
        System.out.println("加密后：" + System.currentTimeMillis());
        System.out.println("加密后：" + encrypt);

        String decrypt = aesDecrypt(encrypt, KEY);
        String decrypt1 = aesDecrypt(encrypt1, KEY);
        System.out.println("解密后：" + System.currentTimeMillis());
    ...
    private static byte[] aesEncryptToBytes(String content, String encryptKey) throws Exception {
        System.out.println("加密后111：" + System.currentTimeMillis());
        KeyGenerator kgen = KeyGenerator.getInstance("AES");
        kgen.init(128);
        Cipher cipher = Cipher.getInstance(ALGORITHMSTR);
        cipher.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(encryptKey.getBytes(), "AES"));
        System.out.println("加密后222：" + System.currentTimeMillis());
